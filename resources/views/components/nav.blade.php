    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #561c23">
        <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('img/logo-head.png') }}" alt="micolegio" width="60%"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item dropdown">
                ...
                @if (Route::has('login'))
                    @auth
                            <a class="dropdown-item" href="{{ url('/dashboard') }}">Dashboard(Usuario)</a>
                @else
                            <a class="dropdown-item" href="{{ route('log') }}">Login</a>
                            {{--
